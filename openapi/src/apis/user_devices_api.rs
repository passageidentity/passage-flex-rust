...
pub async fn delete_user_devices(configuration: &configuration::Configuration, user_id: &str, device_id: &str) -> Result<(), Error<DeleteUserDevicesError>> {
    ...
    let local_var_uri_str = format!("{}/users/{user_id}/devices/{device_id}", local_var_configuration.base_path, user_id=crate::apis::urlencode(user_id), device_id=crate::apis::urlencode(device_id));
...
pub async fn list_user_devices(configuration: &configuration::Configuration, user_id: &str) -> Result<models::ListDevicesResponse, Error<ListUserDevicesError>> {
    ...
    let local_var_uri_str = format!("{}/users/{user_id}/devices", local_var_configuration.base_path, user_id=crate::apis::urlencode(user_id));
