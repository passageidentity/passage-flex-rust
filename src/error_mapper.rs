...
fn convert_error<Src>(error: openapi::apis::Error<Src>, map_fn: fn(Src) -> Error) -> Error {
    match error {
        openapi::apis::Error::Reqwest(e) => Error::Reqwest(e), // Forward the reqwest error directly
        openapi::apis::Error::Serde(e) => Error::Serde(e),     // Forward the serde error directly
        openapi::apis::Error::Io(e) => Error::Io(e),           // Forward the I/O error directly
        openapi::apis::Error::ResponseError(response) => match response.entity {
...
impl From<openapi::apis::Error<apps_api::GetAppError>> for Error {
    fn from(e: openapi::apis::Error<apps_api::GetAppError>) -> Self {
...
impl From<openapi::apis::Error<transactions_api::CreateRegisterTransactionError>> for Error {
    fn from(e: openapi::apis::Error<transactions_api::CreateRegisterTransactionError>) -> Self {
        convert_error(e, |e| match e {
...
impl From<openapi::apis::Error<transactions_api::CreateAuthenticateTransactionError>> for Error {
    fn from(e: openapi::apis::Error<transactions_api::CreateAuthenticateTransactionError>) -> Self {
        convert_error(e, |e| match e {
...
impl From<openapi::apis::Error<authenticate_api::AuthenticateVerifyNonceError>> for Error {
    fn from(e: openapi::apis::Error<authenticate_api::AuthenticateVerifyNonceError>) -> Self {
        convert_error(e, |e| match e {
...
impl From<openapi::apis::Error<users_api::ListPaginatedUsersError>> for Error {
    fn from(e: openapi::apis::Error<users_api::ListPaginatedUsersError>) -> Self {
        convert_error(e, |e| match e {
...
impl From<openapi::apis::Error<users_api::GetUserError>> for Error {
    fn from(e: openapi::apis::Error<users_api::GetUserError>) -> Self {
        convert_error(e, |e| match e {
...
impl From<openapi::apis::Error<user_devices_api::ListUserDevicesError>> for Error {
    fn from(e: openapi::apis::Error<user_devices_api::ListUserDevicesError>) -> Self {
        convert_error(e, |e| match e {
...
impl From<openapi::apis::Error<user_devices_api::DeleteUserDevicesError>> for Error {
    fn from(e: openapi::apis::Error<user_devices_api::DeleteUserDevicesError>) -> Self {
        convert_error(e, |e| match e {
...
impl From<openapi::models::model_401_error::Model401Error> for Error {
    fn from(e: openapi::models::model_401_error::Model401Error) -> Self {
        match e.code {
            openapi::models::model_401_error::Code::AccessToken => Error::InvalidAccessToken,
            openapi::models::model_401_error::Code::Nonce => Error::InvalidNonce,
        }
    }
}

impl From<openapi::models::model_400_error::Model400Error> for Error {
    fn from(e: openapi::models::model_400_error::Model400Error) -> Self {
        match e.code {
            openapi::models::model_400_error::Code::InvalidRequest => Error::InvalidRequest,
            _ => Error::Other(e.error),
        }
    }
}

impl From<openapi::models::model_403_error::Model403Error> for Error {
    fn from(e: openapi::models::model_403_error::Model403Error) -> Self {
        match e.code {
            openapi::models::model_403_error::Code::OperationNotAllowed => {
...
impl From<openapi::models::model_409_error::Model409Error> for Error {
    fn from(e: openapi::models::model_409_error::Model409Error) -> Self {
        match e.code {
            openapi::models::model_409_error::Code::HasNoPasskeys => Error::UserHasNoPasskeys,
            _ => Error::Other(e.error),
        }
    }
}

impl From<openapi::models::model_500_error::Model500Error> for Error {
    fn from(_: openapi::models::model_500_error::Model500Error) -> Self {
