...
pub async fn delete_user_devices(
    configuration: &configuration::Configuration,
    user_id: &str,
    device_id: &str,
) -> Result<(), Error<DeleteUserDevicesError>> {
    ...
    let local_var_uri_str = format!(
        ...
        device_id = crate::openapi::apis::urlencode(device_id)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteUserDevicesError> =
...
pub async fn list_user_devices(
    configuration: &configuration::Configuration,
    user_id: &str,
) -> Result<models::ListDevicesResponse, Error<ListUserDevicesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListUserDevicesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
